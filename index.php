    ...
    <div class="main_container">
              ...
              <ul class="nav side-menu">
                ...
                <li><a href="#"><i class="fa fa-desktop"></i> Data Siswa <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="index.php?page=tampil_mhs">Tampil Siswa</a></li>
                    <li><a href="index.php?page=tambah_mhs">Tambah Siswa</a></li>
                  </ul>
                </li>
                <li><a><i class="fa fa-desktop"></i> Data Guru <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="index.php?page=tampil_gru">Tampil Guru</a></li>
                    <li><a href="index.php?page=tambah_gru">Tambah Guru</a></li>
                  </ul>
                </li>
            ...
            <ul class=" navbar-right">
              <li class="nav-item dropdown open">
                <a href="#" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                  <img src="assets/images/almadani.jpg" alt="">SMK Al-MADANI GARUT
                </a>
      ...
      <footer>
        <div class="pull-right">
          Copyright @ 2021 Aplikasi Data Sekolah : Asep Kurniawan Hidayatulloh
        </div>
        <div class="clearfix"></div>
      </footer>
      <!-- /footer content -->
